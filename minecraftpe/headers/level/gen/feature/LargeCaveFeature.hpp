...
struct LargeCaveFeature : public LargeFeature{
	...
	virtual void addFeature(Level* level, int32_t a3, int32_t a4, int32_t a5, int32_t a6, uint8_t* blocks, int32_t a8) {
		Random* p_random; // r4
		int32_t v12;	  // r10
		int32_t v13;	  // r8
		int32_t v14;	  // r6
	...
	void addTunnel(int32_t a2, int32_t a3, uint8_t* blocks, float a5, float a6, float a7, float a8, float a9, float a10, int32_t a11, int32_t a12, float a13) {
		int32_t v17;   // r9
		int32_t v19;   // r8
		int32_t v20;   // r10
		int32_t v21;   // r6
